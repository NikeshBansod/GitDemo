...
@Controller
public class WizardFileUploadController {
	...
	@RequestMapping(value = "/wGetLogoPage", method = RequestMethod.GET)
	public String getLogoPage(Model model) {
		return PageRedirectConstants.WIZARD_GET_LOGO_UPLOAD_PAGE;
	}
	
	@RequestMapping(value = "/wUploadLogo", method = RequestMethod.POST, produces = {"application/json"})
    public String uploadOrgLogo(MultipartHttpServletRequest request,HttpServletResponse httpResponse,HttpServletRequest httpRequest,Model model) throws Exception {
        ...
        try {
             ...
             if(!formatsAllowed.contains(ext) || !formatsAllowed.contains(mime) ){
        		 ...
        		 pageRedirect=PageRedirectConstants.WIZARD_GET_LOGO_UPLOAD_PAGE;
	...
	@RequestMapping(value = "/wGetOrgLogo", method = RequestMethod.GET)
