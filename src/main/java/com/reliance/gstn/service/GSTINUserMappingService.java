 ...
 *
 */
public interface GSTINUserMappingService {
	...
	boolean checkIfGSTINUserExists(Integer referenceUserId)throws Exception;
	...
	List<GstinLocation> getGstinLocationGstinId(Integer gstinid)throws Exception;
