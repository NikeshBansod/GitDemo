...
public interface CustomerDao {
	...
	String deleteCustomerDetails(Integer id)throws Exception;
	...
	List<Object[]> getSupplierListBySupplNameAndMobileNo(Integer orgUid,String query, String documentType)throws Exception;
