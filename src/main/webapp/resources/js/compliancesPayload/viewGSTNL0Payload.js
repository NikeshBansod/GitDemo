...
{
	 document.gobacktoasphomeforotperror.action ="./gobacktoasphomeforotperror";
...
function displayDataInHtml(b2btotalinvoices,b2btotaltaxableamt,b2btotaltaxamt,
	...
	$("#L0Table").append(
		     '<table class="table table-bordered m-table-first-col-200 hide_row" >'
			    +'<tr class="m-table-header-color" bgcolor="#D5D8FD">'
			    ...
			    +'<tr>'
				    ...
				    +'<td width="30%" class="text-right">'+(b2btotaltaxableamt).toFixed(2)+'</td>'
			    +'</tr>'
			    +'<tr>'
				    +'<td  width="70%" bgcolor="#E9E9ED">Tax Amount (₹)</td>'
				    +'<td width="30%" class="text-right">'+(b2btotaltaxamt).toFixed(2)+'</td>'
			    +'</tr>'
			   /* +'<tr class="b2bdata" >'
		 ...
		 $("#L0Table").append(
			...
			'<table class="table table-bordered m-table-first-col-200 ">'
			    ...
			    +'<tr>'
				    +'<td  width="70%" bgcolor="#E9E9ED">Taxable amount(₹):</td>'
				    +'<td width="30%" class="text-right">'+(b2cltotaltaxableamt).toFixed(2)+'</td>'
			    +'</tr>'
			    +'<tr>'
				    +'<td  width="70%" bgcolor="#E9E9ED">Tax Amount (₹)</td>'
				    +'<td width="30%" class="text-right">'+(b2cltotaltaxamt).toFixed(2)+'</td>'
			    +'</tr>'
			    /*+'<tr class="b2cldata">'
			    +'<td width="70%" bgcolor="#E9E9ED">Not Saved to GSTN:</td>'
		 ...
		 $("#L0Table").append(
			...
			'<table class="table table-bordered m-table-first-col-200 ">'
			    ...
			    +'<tr>'
				    +'<td width="70%" bgcolor="#E9E9ED">Taxable amount(₹):</td>'
				    +'<td width="30%" class="text-right">'+(b2cstotaltaxableamt).toFixed(2)+'</td>'
			    +'</tr>'
			    +'<tr>'
				    +'<td width="70%" bgcolor="#E9E9ED">Tax Amount (₹)</td>'
				    +'<td width="30%" class="text-right">'+(b2cstotaltaxamt).toFixed(2)+'</td>'
			    +'</tr>'
		    +'</table>'
		 ...
		 $("#L0Table").append(
					...
					'<table class="table table-bordered m-table-first-col-200 ">'
					    ...
					    +'<tr>'
						    +'<td  width="70%" bgcolor="#E9E9ED">Taxable amount(₹):</td>'
						    +'<td width="30%" class="text-right">'+(cndntotaltaxableamt).toFixed(2)+'</td>'
					    +'</tr>'
					    +'<tr>'
						    +'<td  width="70%" bgcolor="#E9E9ED">Tax Amount (₹)</td>'
						    +'<td width="30%" class="text-right">'+(cndntotaltaxamt).toFixed(2)+'</td>'
					    +'</tr>'
					    /*+'<tr class="b2cldata">'
					    +'<td width="70%" bgcolor="#E9E9ED">Not Saved to GSTN:</td>'
					    +'<td width="30%"class="text-right">'+b2clgstnnotsavedcnt+'</td>'
		 ...
		 $("#L0Table").append(
					...
					'<table class="table table-bordered m-table-first-col-200 ">'
					    ...
					    +'<tr>'
						    +'<td  width="70%" bgcolor="#E9E9ED">Taxable amount(₹):</td>'
						    +'<td width="30%" class="text-right">'+(cndurtotaltaxableamt).toFixed(2)+'</td>'
					    +'</tr>'
					    +'<tr>'
						    +'<td  width="70%" bgcolor="#E9E9ED">Tax Amount (₹)</td>'
						    +'<td width="30%" class="text-right">'+(cndurtotaltaxamt).toFixed(2)+'</td>'
					    +'</tr>'
					    /*+'<tr class="b2cldata">'
					    +'<td width="70%" bgcolor="#E9E9ED">Not Saved to GSTN:</td>'
					    +'<td width="30%"class="text-right">'+b2clgstnnotsavedcnt+'</td>'
