...
$(document).ready(function(){ 
	$( "#service_add,#service_edit" ).on( "click", function(e) {
		...
		if ((errFlag0)|| (errFlag1) || (errFlag2) || (errFlag3) || (errFlag4) || (errFlag5) || (errFlag6) || (errFlag7) || (errFlag9) || (errFlag10) || (errFlag11) || (errFlag13) ||(errFlag14) ||(errFlag15) || (errFlag16) || (gstinStateValid) ||(errFlag17)|| (errFlag18) || (errFlag19) || (errFlag20) || (errFlag21)){
			 e.preventDefault();	 
		}else{
