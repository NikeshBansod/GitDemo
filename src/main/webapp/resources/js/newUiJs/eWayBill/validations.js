...
// used by Dibyendu Mukherjee for cancellation of Invoice Eway bill 
			 ...
			 $.ajax({
					...
					success:function(json,fTextStatus,fRequest){
						...
						if(json.status == 'success'){
							...
							$("#nicUserDetails").css('display','none');*/
						}
						...
						$("#nicPwdDiv").css('display','none');
						$("#nicUserDetails").css('display','none');
						$("#nicLoginDetails").css('display','none');*/
