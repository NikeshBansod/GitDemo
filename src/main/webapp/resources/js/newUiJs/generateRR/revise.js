function showUserDetailsInInvoicePreview(responseJson){
	...
	$("#userDetailsInInvoicePreview").append(
			...
			+'<strong>Invoice No : </strong>'+responseJson.invoiceDetails.invoiceNumber +'<br/>'
...
function showBillToAndShipToInPreviewDiv(responseJson){
	...
	var placeOfSupply = '';
	 var custStateCodeId = '';
	  if(responseJson.invoiceDetails.customerDetails.custGstinState){
  ...
  $("#customerDetailsBillToDivInInvoicePreview").append(
		  ...
		  +'<strong>GSTIN/Unique Code : </strong>'+responseJson.invoiceDetails.customerDetails.custGstId+'<br>'
