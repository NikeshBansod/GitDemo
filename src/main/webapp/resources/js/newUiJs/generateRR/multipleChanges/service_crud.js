    ...
    function resetFormValues(){
    	...
    	$('#cess').val("");
    	setValueInSelectCessNonAdvol(0,0,$('input[name=invoiceFor]').filter(':checked').val());
    	$('#offerAmount').val("");
    	$('#hsnSacCode').val("");
    ...
    $(document).ready(function() { 
    	...
    	}).datepicker("setDate", new Date(formatDateInDDMMYYYY()));
    });
    
    function formatDateInDDMMYYYY(){
    	var inputDate = $("#old_invoiceDate").val();
