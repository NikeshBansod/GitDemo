        		...
        		success:function(json,textStatus,request){
        			...
        			if(isValidToken(json) == 'No'){
        			 ...
        			 $.each(json,function(i,value){
        				 if (typeof value.emailId !== 'undefined')
		        			{emailId = value.emailId}
        				 $('#employeeTab tbody:last-child').append('');
        						 $('#employeeTab tbody:last-child')
        							.append('<tr>'
	...
	function validateEmailId(){
	 ...
	 $("#confPasswordSecUser").on("keyup input", function(){
		 ...
		 if ($("#password").val() != $("#confPasswordSecUser").val()){
			 ...
			 $("#confPasswordSecUser").addClass("input-error")
