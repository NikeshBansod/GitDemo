...
//	 var errFlag7 = validateState(); 
	 ...
	 */
	 ...
	 if ( (errFlag) || (errFlag1) ||  (errFlag3) // || (errFlag5)	|| (errFlag6) || (errFlag7) 
			 ||  (errFlag9)  
			|| (errFlag12)|| (errFlag14) || (errFlag15) || (errFlag20) || (errFlag21) ||(otpValidated) || (errFlagNatureOfBusiness) || (termsConditionsStatus)){
		 e.preventDefault();	 
	 }else{
		 finalSubmit = true;
	 }
