...
function add_chg_row(){ 
    $(document).ready(function(){ 
    	...
    	if(additionalChargeAmount && (additionalChargeAmount > 0)){
        	...
        	$addChgToggle.append('<div id="add_chg_start_'+recordNo+'">'
				        			+'<div class="heading">'
						                +'<div class="cust-con">'
...
function edit_add_chg_row(recordNo){
	...
	$('#additionalChargeName').val($('#additionalChargeId-'+recordNo).val()+"{--}"+$('#additionalChargeName-'+recordNo).val()+"{--}"+$('#additionalChargeAmount-'+recordNo).val());
