    ...
    function resetFormValues(){
    	...
    	//set quantity = 1 when bill method is lumpsum else set it blank - Start
    	...
    	$("#uom-show-hide").hide();   
  	    ...
  	    clearInputErrorClass("quantity","quantity-req");
  	    clearInputErrorClass("service_name","service_name-req");
