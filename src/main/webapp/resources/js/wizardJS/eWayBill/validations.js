									...
									success:function(json,fTextStatus,fRequest){
										...
										if(json.status == 'success'){
											bootbox.alert("Successfully generated EWay Bill No - "+json.ewayBillNo, function() {
												...
												getWizardEWayBills(inputData.invoiceId);
												return;
											});
										}
...
function getWizardEWayBills(idValue){
	document.manageInvc.action = "./wgetEWayBills";
	document.manageInvc.id.value = idValue;
	document.manageInvc._csrf_token.value = $("#_csrf_token").val();
	document.manageInvc.submit();
}
