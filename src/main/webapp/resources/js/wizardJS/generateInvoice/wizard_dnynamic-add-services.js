...
$(document).ready(function(){	
	...
	$("#dnyAddNewService,#dnyAddNewProduct").click(function(e){		
		...
		if(e.currentTarget.id == 'dnyAddNewProduct'){
			$("#generateInvoiceProductDetailsPageHeader").show();
		}else{
			$("#generateInvoiceServiceDetailsPageHeader").show();
		}
		$("#addInvoiceDiv").hide();
	...
	$("#dnyServiceCancelBtn").click(function(e){
		...
		$("#generateInvoiceServiceDetailsPageHeader").hide();		
	});
...
function loadUnitOfMeasurement(){
	$.ajax({
		...
		success:function(json,fTextStatus,fRequest){			
			...
			$("#dny-unitOfMeasurement").append('<option value="">Select</option>');
...
function loadRateOfServiceTax(){
	  $.ajax({
			...
			success:function(json,fTextStatus,fRequest){
				$("#dny-serviceIgst").empty();
				$("#dny-serviceIgst").append('<option value="">Select</option>');
