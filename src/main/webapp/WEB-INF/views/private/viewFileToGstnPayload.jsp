...
<div class="m-page-title" style=" background-color:white">
        ...
        <span style=" float:right;">File GSTR1</span></h5>
...
<script type="text/javascript" src="<spring:url value="/resources/js/compliancesPayload/viewFileToGstnPayload.js"/>"></script>
