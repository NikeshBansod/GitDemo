...
<script type="text/javascript" src="<spring:url value="/resources/js/wizardJS/organization/wizardManageOrganization.js"/>"></script>
<c:if test="${not empty response}">
	...
	<form:form modelAttribute="userMaster" method="post" id="updateUserMasterFormId" action="./wUpdateUser" >
	<input type="hidden" id="_csrf_token" name="_csrf_token" value="${_csrf_token}" />
<section class="insidepages">
	<div class="inside-cont">
		<div id="editPageContainer">
	     <!--  <form:form modelAttribute="userMaster" method="post" id="updateUserMasterFormId" action="./wUpdateUser" > -->
	        <div class="breadcrumbs"><a href="./wHome">Home</a> <span>&raquo;</span> My Profile</div>
	        <div class="account-det">
	          <div class="det-row">
		            ...
		            <div class="det-row-col astrick" id="divOtherOrgType" style="display: none; float: right;">
	          ...
	          <div class="det-row"> 
		             ...
		             <div class="det-row-col">
		            	<div class="label-text">Aadhar No for e-Sign</div>
	          ...
	          <%-- values are set in hidden for commented fields for already existing data --%>
	          <form:hidden path="organizationMaster.city" id="city" value="${userMasterObj.organizationMaster.city }" />
	          <form:hidden path="organizationMaster.state" id="state" value="${userMasterObj.organizationMaster.state }" />
	          <form:hidden path="organizationMaster.regdOfficeDetails" id="regdOfficeDetails" value="${userMasterObj.organizationMaster.regdOfficeDetails }" />
	          <form:hidden path="organizationMaster.address1" id="address1" value="${userMasterObj.organizationMaster.address1}" />
	          <form:hidden path="organizationMaster.pinCode" id="pinCode" value="${userMasterObj.organizationMaster.pinCode}" />
	          <form:hidden path="organizationMaster.natureOfBusiness" value="${userMasterObj.organizationMaster.natureOfBusiness }" id="natureOfBusiness" />
	          <form:hidden path="organizationMaster.principalPlaceOfBusiness" id="principalPlaceOfBusiness" value="${userMasterObj.organizationMaster.principalPlaceOfBusiness}" />
	         ...
	         <%--  <div class="det-row">
		            ...
		            <div class="det-row-col ">
		            	<div class="label-text">Registered Office Details (max 200 characters) </div>
		              	<form:input path="organizationMaster.regdOfficeDetails" maxlength="200" id="regdOfficeDetails" value="${userMasterObj.organizationMaster.regdOfficeDetails }" class="form-control"  />
		            </div>    
	          </div>
	          <div class="det-row">
		            <div class="det-row-col astrick">
		            ...
		            <div class="det-row-col">
		            	<div class="label-text">Nature Of Business </div>
	                    ...
	                    <form:input path="natureOfBusiness.natureOfBusinessType" value="${userMaster.natureOfBusiness.natureOfBusinessType}" type="hidden" id="natureOfBusinessTypeHidden" />
		            </div> 
		            <br> 
		            <div class="det-row-col astrick" id="divOtherNatureOfBusiness" >
		            	<div class="label-text">Specify Nature Of Business </div>
		            	...
		            	<input type="hidden" id="otherNatureOfBusinessHidden" value="${userMasterObj.organizationMaster.otherNatureOfBusiness }">
		          		<input type="hidden" id="otherNatureOfBusinessHidden" >
		          		<form:input path="otherNatureOfBusiness" id="otherNatureOfBusiness" class="form-control" maxlength="200"/>
		          		<span class="text-danger cust-error" id="otherNatureOfBusiness-req">This field is required.</span>
		          	</div>      
	          </div>  --%>
	          <div class="det-row">
		            <div class="det-row-col ">
		            	<div class="label-text">CIN (Corporate Identity Number)</div>
		              	<form:input path="organizationMaster.cin" id="cin" maxlength="21" value="${userMasterObj.organizationMaster.cin}" class="form-control"   />
		              	<span class="text-danger cust-error" id="cust-cin-format">This field should be in proper format</span>
		            </div>
		           <%--  <div class="det-row-col ">
		            	<div class="label-text">Principal Place Of Business (max 200 characters) </div>
	        ...
	        <div class="det-row"> 
	        	<img alt="No Logo Uploaded" onerror="this.src='${pageContext.request.contextPath}/resources/images/no_image_available.jpg';" width="65" height="50" class="img-responsive" src="${pageContext.request.contextPath}/wGetOrgLogo">
	        </div>	
	        <div class="insidebtn"> 	        	
	        	<a class="sim-button button6" id="uploadLogo"  href="#"><span>Click here to Change/Upload Logo</span></a> 
	        	<input id="UpdateBtn" type="Submit" class="sim-button button5" value="Save"  formnovalidate="formnovalidate" />
		...
		<div id="termsAndConditionsId" style="display:none">
			<div class="breadcrumbs"><a href="<spring:url value="./wEditUser"/>" id="backToMyProfile" >My Profile</a> <span>&raquo;</span>TERMS AND CONDITIONS OF SERVICES TO MERCHANT</div>
			<main>
			<div class="account-det">
				<h4>WELCOME TO Bill Lite!</h4>
                       ...
                       <p class="tncli">9.6.	The Service Provider does not guarantee that the Services will be uninterrupted, timely, secure or error-free or that content loss won’t occur, nor does it guarantee any connection to or transmission from computer networks. It shall strive to keep the Services up and running; however, all online services suffer occasional disruptions and outages, and the Service Provider shall not be liable for any disruption or loss that the Merchant may suffer as a result. In the event of an outage, the Merchant may not be able to retrieve the data that has been stored.</p>
                        ...
                        <p class="tncli text-center"><strong>Annexure-1</strong><br>List of Services</p>
			...
			<div class="insidebtn"> 
				<input type="button" class="sim-button button5" id="iAgree" value="I Agree"/>
		    </div>
		    </main>
		</div>
	</div>
