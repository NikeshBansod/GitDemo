...
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/registrationunifi/registration.js"/>"></script>
...
<%-- <form:form commandName="userMaster" method="post" action="./registrationunification"> --%>
              ...
              <div class="row">
               <div class="col-md-4">
                       <div class="form-group input-field mandatory">
                                ...
                                <input type="text" id="pan-number" maxlength="10" required="true" class="form-control"/>
                      ...
                      <div class="col-md-4">
                            <div class="form-group input-field mandatory">
                             ...
                             <div class="col-md-4">
                            <div class="form-group input-field mandatory">
                                <label for="">EmailId <span>*</span>
                                <input type="text" class="form-control" id="emailId" maxlength="100" required="true"  />
              					<%-- <form:input path="emailId" name="emailId" type="hidden" class="form-control" id="hiddenemailId" maxlength="10" required="true"  /> --%>
                                <span class="text-danger cust-error" id="emailId-req">This field is required and should be 10 digits</span>
		                  		<span class="text-danger cust-error" id="emailId-exist"></span></label>
		                  		</div>
                            </div>
               </div>
               <div class="row">
                     <div class="col-md-4">
                       <div class="form-group input-field mandatory">
                                ...
                                <input type="password"  maxlength="25"  id="password" required="true" class="form-control"/>
			                    </label>
                      ...
                      <div class="col-md-4">
                       <div class="form-group input-field mandatory">
			                   ...
			                   <span class="text-danger cust-error" id="conf-password-req">This field is required</span>
			                  	<span class="text-danger cust-error" id="password-format">Min 1 digit, 1 Uppercase letter, 1 lowercase letter, 1 special character</span></label>
			                  	</div>
                      </div>
                      <div class="col-md-12 button-wrap">
				        <button class="btn btn-success blue-but" style="width: auto;" id="RegisterBtn" type="submit" formnovalidate>Submit</button>
				     </div>
                </div>
