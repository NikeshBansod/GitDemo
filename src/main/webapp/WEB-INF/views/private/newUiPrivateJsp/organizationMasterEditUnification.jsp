...
<section class="block">
	<form:form modelAttribute="userMasterUnification" method="post"  action="./updateuserprofileunificationsave">
		<div class="container">
		<input type="hidden" id="_csrf_token" name="_csrf_token"
				value="${_csrf_token}" />
				
	<div class="page-title" id="listheader">
				<a href="<spring:url value="./homeUnifi"/>" class="back"><i class="fa fa-chevron-left"></i></a>My Profile
		</div>
			 ...
			 <h1 class="box-section-title">Organization details</h1>
				...
				<div class="col-md-4">
								<label for="">PAN<span> *</span> <input type="text"
									disabled="true"
									value="${userMasterObj.organizationMasterUnification.panNumber}"
					...
					<div class="col-md-4">
								<label for="">Firm Name<span> *</span> <form:input
										...
										maxlength="100"
										value="${userMasterObj.organizationMasterUnification.orgName}"
							...
							<div class="col-md-4" style="display: none;">
								<label for="">Firm Type <span> *</span> <input
									...
									value="" /> <form:select
										...
										value="${userMasterObj.organizationMasterUnification.orgType}"
							...
							<div class="col-md-4" style="display: none;" id="divOtherOrgType"
								...
								<label for="">Specify Firm Type <span> *</span> <input
									...
									value="" /> <form:input
										...
										id="otherOrgType"
										value="${userMasterObj.organizationMasterUnification.otherOrgType}"
										class="form-control" />
								</label>
							</div>
				...
				<div class="col-md-4">
								<label for="">Email Id<span> *</span> 
									<form:input
										...
										value="${userMasterObj.organizationMasterUnification.orgEmailId}"
										class="form-control" />
							...
							<div class="col-md-4">
								<label for="">Aadhar No.for e-Sign <form:input
										path="organizationMasterUnification.adharEsign" id="secUserAadhaarNo"
										value="${userMasterObj.organizationMasterUnification.adharEsign}"
				 ...
				 <div class="col-md-4">
								<label for="">CIN (Corporate Identity Number) <form:input
										...
										value="${userMasterObj.organizationMasterUnification.cin}"
										class="form-control" />
									<!-- name ="aadharNoForEsign" -->
							...
							<div class="col-md-4">
								<label for="">Pin Code:<span> *</span> <form:input
										...
										value="${userMasterObj.organizationMasterUnification.pinCode}"
										class="form-control" />
									<!-- name ="aadharNoForEsign" -->
							...
							<div class="col-md-4">
								<label for="">Landline No: <form:input
										...
										value="${userMasterObj.organizationMasterUnification.landlineNo}"
										class="form-control" />
									<!-- name ="aadharNoForEsign" -->
								</label> 
							</div>
							<div class="col-md-4">
								<label for="">Address Line1:<span> *</span> <form:input
										path="organizationMasterUnification.address1" id="address1" maxlength="50"
										value="${userMasterObj.organizationMasterUnification.address1}"
										class="form-control" />
									<!-- name ="aadharNoForEsign" -->
								</label> 
							</div>
							<div class="col-md-4">
								<label for="">Address Line2: <form:input
										path="organizationMasterUnification.address2" id="address1" maxlength="50"
										value="${userMasterObj.organizationMasterUnification.address2}"
										class="form-control" />
									<!-- name ="aadharNoForEsign" -->
								</label> 
							</div>
							<%-- <div class="col-md-4">
								<label for="">STD Code: <form:input
										...
										value="${userMasterObj.organizationMasterUnification.stdCode}"
										class="form-control" />
									<!-- name ="aadharNoForEsign" -->
								</label> 
							</div> --%>
		...
		<div class="form-group">
		                    <div class="col-md-4">
						     ...
						     <%--   <form:select path="prefix"  id="prefix"> --%>
						        <form:input path="prefix" id="prefix"
										maxlength="100"
										value="${userMasterObj.prefix}"
										class="form-control" disabled="true"/>
							...
							<div class="col-md-4">
								...
								<form:input path="gender" id="gender"
										maxlength="10"
										value="${userMasterObj.gender}"
										class="form-control" disabled="true"/>
							     <%-- <form:select path="gender"  id="gender">
							    <form:option value="${userMasterObj.gender}">Select </form:option> 
							...
							<div class="col-md-4">
								...
								<form:input path="department" id="department"
										maxlength="100"
										value="${userMasterObj.department}"
										class="form-control" disabled="true"/>
								</label> 
							...
							<div class="col-md-4">
								...
								<form:input path="designation" id="designation"
										maxlength="100"
										value="${userMasterObj.designation}"
										class="form-control" disabled="true"/>
								</label> 
							</div>
							...
							<div class="col-md-4">
								<label for="">Landline No:
								 <form:input path="userLandlineNo" id="userLandlineNo"
										value="${userMasterObj.userLandlineNo}"
										class="form-control" disabled="true" />
								</label> 
							</div>
							...
							<%-- <div class="col-md-4">
								<label for="">STD Code:
								 <form:input path="userStdCode" id="userStdCode"
										value="${userMasterObj.userStdCode}"
										class="form-control" />
								</label> 
							</div> --%>
							...
							<div class="col-md-4">
								<label for="">Email Id:<span> *</span>
								 <form:input path="emailId" id="emailId"
										value="${userMasterObj.defaultEmailId}"
										class="form-control" disabled="true" />
								</label> 
							</div>
							<%-- <div class="col-md-4">
		...
		<form:hidden path="id" value="${userMasterObj.id }" />
					...
					<input type="hidden" id="termsConditionsFlagHidden"
						...
						value="${userMasterObj.organizationMasterUnification.termsConditionsFlagHidden}" />
					...
					<input type="hidden" id="logoUploadFlag"
						...
						value="${userMasterObj.organizationMasterUnification.logoUploadFlag}">
					<input type="hidden" id="logoImagePath"
						name="organizationMasterUnification.logoImagePath"
						value="${userMasterObj.organizationMasterUnification.logoImagePath}">
					<input type="hidden" id="companyId"
						name="organizationMasterUnification.companyId"
						value="${userMasterObj.organizationMasterUnification.companyId}">
...
<script type="text/javascript"
	src="<spring:url value="/resources/js/newUiJs/registrationunifi/registration_additional.js"/>"></script>
