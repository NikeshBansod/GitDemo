...
<section class="block">
   ...
   <div class="loader"></div>
	...
	<div class="container" id="addInvoiceDiv">  
	  <div class="brd-wrap page-title">
		 <div id="generateInvoiceDefaultPageHeader">
            <c:if test="${documentType == 'invoice'}">
            	<%-- <a href="<spring:url value="/getInvoices"/>"><strong>Invoice History</strong></a> &raquo; <strong id="">Generate Invoice</strong> --%>
            	  <a href="<spring:url value="/getInvoices"/>" class="back"><i class="fa fa-chevron-left"></i></a>Generate Invoice
            </c:if>
            <c:if test="${documentType == 'billOfSupply'}">
            	<%-- <a href="<spring:url value="/getBOS"/>"><strong>Bill Of Supply History</strong></a> &raquo; <strong id="">Generate Bill Of Supply </strong> --%>
            	  <a href="<spring:url value="/getBOS"/>" class="back"><i class="fa fa-chevron-left"></i></a>Generate Bill Of Supply
            </c:if>
            <c:if test="${documentType == 'rcInvoice'}">
            <%-- 	<a href="<spring:url value="/getRCInvoice"/>"><strong>Reverse Charge Invoice History</strong></a> &raquo; <strong id="">Generate Reverse Charge Invoice</strong> --%>
            	  <a href="<spring:url value="/getRCInvoice"/>" class="back"><i class="fa fa-chevron-left"></i></a>Generate Reverse Charge Invoice
            </c:if>
            <c:if test="${documentType == 'eComInvoice'}">
            	<%-- <a href="<spring:url value="/getEComInvoice"/>"><strong>E-Commerce Invoice History</strong></a> &raquo; <strong id="">Generate E-Commerce Invoice</strong> --%>
            	  <a href="<spring:url value="/getEComInvoice"/>" class="back"><i class="fa fa-chevron-left"></i></a>Generate E-Commerce Invoice
            </c:if>
            <c:if test="${documentType == 'eComBillOfSupply'}">
            	<%-- <a href="<spring:url value="/getEComBOS"/>"><strong>E-Commerce Bill Of Supply History</strong></a> &raquo; <strong id="">Generate E-Commerce Bill Of Supply</strong> --%>
            	  <a href="<spring:url value="/getEComBOS"/>" class="back"><i class="fa fa-chevron-left"></i></a><h3 id="internalBreadCrum">Generate E-Commerce Bill Of Supply</h3>
            </c:if>
 		 </div>
	  </div>
	  ...
	  <!-- Start of row 1 -->
	  	<div class="row">
	  		<div class="col-md-4" style="display:block" id="documentType-div">
	  			...
	  			<input type="hidden" id="modeOfCreation" value="CREATE_INVOICE">
	...
	<div class="container" id="dnyServiceProductDiv" style="display:none"> 
		<div id="dnyServiceFormDiv">
			...
			<div class="page-title">
                  <a href="javascript:void(0)" id="dny-service-cancel-link" class="back"><i class="fa fa-chevron-left"></i></a>Add Service
           </div>
			<div class="form-wrap">
			<!-- Start of row 1 -->
			    <div class="row">
	    ...
	    <div id="dnyProductFormDiv">
			...
			<div class="page-title">
                  <a href="javascript:void(0)" id="dny-product-cancel-link" class="back"><i class="fa fa-chevron-left"></i></a>Add Product
           </div>
			<div class="form-wrap">
	        <!-- Start of row 1 -->
	        	<div class="row">
	...
	<!-- 	<div class="brd-wrap">
			...
			<div class="page-title">
                  <a href="javascript:void(0)" id="dny-additional-charge-cancel-link" class="back"><i class="fa fa-chevron-left"></i></a>Add Additional Charge
           </div>
		<div class="form-wrap">
        <!-- Start of row 1 -->
        	<div class="row">
	...
	<div class="container" id="dnyCustomerDiv" style="display:none">
		...
		<div class="page-title">
             <a href="javascript:void(0)"  class="back"><i class="fa fa-chevron-left"></i></a>Add Customer
        </div>
	   <div class="form-wrap">
	  	    <!-- Start of row 1 -->
	  		<div class="row">
	                    	...
	                    	<table class="table table-condensed" id="mytable2">
	                            <thead>
	                                <tr>
	                                    ...
	                                    <td style="float:right"><strong>Price/UOM(Rs)</strong></td>
	                                    <td style="float:right"><strong>Disc(Rs.)</strong></td>
	                                    <td style="float:right"><strong>Total (Rs.) After Disc</strong></td>
	                                </tr>
	                            </thead>
	                            <tbody>
...
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/form_submit.js"/>"></script>     
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/service_crud.js"/>"></script>   
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/add_charge_crud.js"/>"></script> 
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/service-product-client.js"/>"></script>       
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/otherFunctions.js"/>"></script> 
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/dnynamic-add-customer.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/dnynamic-add-customer-validations.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/dnynamic-add-services.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/dnynamic-add-products.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/generateInvoice/pincode-autocomplete.js"/>"></script>