...
<!--  <div class="brd-wrap">
	    	<div  id="listheader">
	       		 <a href="#" id="goBackToAspHomepage"><strong>Compliance</strong></a> &raquo; <strong>GSTR1 DRAFT</strong>
	        </div>
	    </div> -->
	    
	              <div class="page-title">
	                    
                        <a href="#" id="goBackToAspHomepage" class="back"><i class="fa fa-chevron-left"></i></a>GSTR1 DRAFT
                    </div>
...
<div id="defaultShowDiv" style='display:none;'>
     <div class="m-page-title" style=" background-color:white">
        ...
        <!-- <span class="m-select-period" style=" float:center;"> <strong>GSTR1 DRAFT</strong></span> -->
...
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/compliancesPayload/viewL0PayloadData.js"/>"></script>
