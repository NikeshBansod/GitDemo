...
<section class="container-fluid e-WayBill">
		...
		<div class="brd-wrap">
			 <div id="generateInvoiceDefaultPageHeader">
	            <a href="#" onclick="javascript:backToValidatePage()"/><strong>NIC User Authentication</strong></a> &raquo; <strong>Generate Eway Bill</strong>
	 		 </div>
	 	</div>
						...
						<div class="panel-body">
							...
							<div class="row" style="margin-top: 10px;">
								<div class="col-md-12 button-wrap"> 
									...
									<button class="btn btn-success blue-but" type="button" onclick="EwayBill.itemvalidation()"> <i class="fa fa-plus"></i> Add Rows</button> 
									<button class="btn btn-success blue-but" type="button" onclick="EwayBill.calculate()">Calculate</button> 
								</div>
							</div>
						</div>
						<div class="panel-body">
...
<script type="text/javascript" src="<spring:url value="/resources/js/addEwayBillWI/bootstrap-datepicker.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/genericEwayBill/populateData.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/genericEwayBill/loadEwayBillWIGrid.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/genericEwayBill/validateEwayBillWI.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/genericEwayBill/pincode-autocomplete.js"/>"></script>