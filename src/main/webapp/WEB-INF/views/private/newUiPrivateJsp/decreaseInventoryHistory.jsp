...
<section class="block">
    ...
    <%--   <div class="brd-wrap">
	    	<div  id="listheader">
	       		<a href="<spring:url value="/home#inventory_management" />"><strong>Inventory</strong></a> &raquo; <strong> Decrease Inventory History </strong>
	        </div>
	    </div> --%>
	    <div class="page-title">
                        <a href="<spring:url value="/home#inventory_management"/>" class="back"><i class="fa fa-chevron-left"></i></a>Decrease Inventory History
                    </div> 
	    <div class="form-wrap">
	    <div class="row"> 
            <div class="col-md-12 button-wrap">
            <a href="./decreaseinventory" class="btn btn-success blue-but" style="width: auto;">Add</a>			
		</div>
		</div>
		</div>
...
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/moment.min.js"/>"></script>
 ...
 <script type="text/javascript" src="./resources/js/newUiJs/increaseDecreaseInventory/decreaseInventoryHistory.js"></script>
