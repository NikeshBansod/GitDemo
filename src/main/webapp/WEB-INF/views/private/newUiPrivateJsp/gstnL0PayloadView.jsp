...
<!--  <div class="brd-wrap">
	    	<div  id="listheader">
	       		 <a href="#" id="goBackToAspHomepage"><strong>Compliance</strong></a> &raquo; <strong>GSTR1 SUBMIT</strong>
	        </div>
	    </div> -->
	      <div class="page-title">
             <a href="#" id="goBackToAspHomepage" class="back"><i class="fa fa-chevron-left"></i></a>GSTR1 SUBMIT
          </div>
...
<div class="row">
		<div class="col-sm">
				...
				<div class="com-but-wrap"><button type="submit" class="btn btn-primary" id="saveToGSTN" formnovalidate="formnovalidate">Submit To GSTN</button></div>
...
<script type="text/javascript" src="<spring:url value="/resources/js/newUiJs/compliancesPayload/viewGSTNL0Payload.js"/>"></script>	    
