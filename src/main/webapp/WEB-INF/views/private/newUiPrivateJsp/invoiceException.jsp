...
<section class="block generateInvoice">
    <div class="container">
    	<div class="brd-wrap">
            <a href="<spring:url value="/getMyInvoices"/>"><strong>Document History</strong></a> &raquo; <strong>Generate Document</strong>
        </div>
        <div class="form-wrap">
            <div class="row">
		    		...
		    		<div style="color:red;font-family:Verdana;font-size:16px">
			    	 	<c:if test="${sessionScope.loginUser.userRole eq 'PRIMARY'}">
			    	 		<c:if test="${isGstinPresent == false }">
			    	 			<b>Please add atleast one GSTIN in order to proceed to 'GENERATE DOCUMENT'.</b><br/>
			    	 		...
			    	 		<c:if test="${sessionScope.loginUser.termsConditionsFlag ne 'Y'}">
			    	 			<b>Please accept terms and Conditions to proceed to  'GENERATE DOCUMENT'.</b><br/>
			    	 	...
			    	 	<c:if test="${sessionScope.loginUser.userRole eq 'SECONDARY'}">
			    	 		<c:if test="${isGstinPresent == false }">
			    	 			<b>Kindly ask your concerned primary member to map GSTIN to your account in order to proceed to 'GENERATE DOCUMENT'.</b><br/>
			    	 		</c:if>
			    	 		
			    	 		
			    	 		<c:if test="${sessionScope.loginUser.termsConditionsFlag ne 'Y'}">
			    	 			<b>Kindly ask your concerned primary member to accept terms and Conditions to proceed to  'GENERATE DOCUMENT'.</b><br/>
			    	 		</c:if>
