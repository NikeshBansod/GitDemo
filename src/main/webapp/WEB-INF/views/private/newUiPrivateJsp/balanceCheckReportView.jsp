...
<section class="block">	
	<div class="container">
		...
		<%-- <div class="brd-wrap">
			<div>
				<a href="<spring:url value="/home#inventory_management"/>"><strong>Inventory</strong></a> &raquo; <strong>Balance Check Report</strong>
			</div>
		</div> --%>
		 <div class="page-title">
                <a href="<spring:url value="/home#inventory_management"/>" class="back"><i class="fa fa-chevron-left"></i></a>Balance Check Report
           </div> 
		<div class="form-wrap">
			<div class="row">
		  		<div class="col-md-4">
		...
		<div id="generateReportGrid">
			<div class="row" id="listTable">
		        <div class="table-wrap">
		            <table id="balanceStocksTab" class="display nowrap" style="width:100%">
			            <thead>
			                <tr>
...
<script type="text/javascript" src="./resources/js/newUiJs/stockSummaryReport/balanceCheckReport.js"></script>
