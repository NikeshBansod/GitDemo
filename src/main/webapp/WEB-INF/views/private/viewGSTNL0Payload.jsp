...
<div class="m-page-title" style=" background-color:white">
        ...
        <span style=" float:right;">Submit GSTR1</span></h5>
...
<div class="mbox draft-tables">
 ...
 <div class="com-but-wrap"><button type="submit" class="btn btn-primary" id="saveToGSTN" formnovalidate="formnovalidate">Submit To GSTN</button>
</div>
...
<script type="text/javascript" src="<spring:url value="/resources/js/compliancesPayload/viewGSTNL0Payload.js"/>"></script>
