...
<main>
                       ...
                       <div class="col-md-4 col-sm-4">
                              <div class="row">
                                  <div class="login-height login-right">
                                      ...
                                      <form autocomplete="off" class="form-signin" method="POST" action="./loginunifiP"> 
	                                      <ul>
	                                          <li>
	                                          ...
	                                          <li>
	                                              <a href="./confirmPasswordLoginUnified" class="forgot">Forgot Mpin?</a>
	...
	<script type="text/javascript" src="./resources/js/newUiJs/loginunifi/additional.js"></script>
</main>