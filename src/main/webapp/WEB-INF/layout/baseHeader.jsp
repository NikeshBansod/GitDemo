...
<header>
    <div class="container">
         ...
         <a href="<spring:url value="/home"/>"><button type="button" id="" class="btn btn-outline-primary box2 "><i class="fa fa-home" aria-hidden="true"></i></button></a>
            ...
            <div class="drop-block">
                <div class="dropdown">
                  ...
                  <c:if test="${sessionScope.loginUser.userRole eq 'PRIMARY'}"> 
                    <li><a href="<spring:url value="./editUser"/>"><i class="fa fa-user" aria-hidden="true"></i> My Profile</a></li>
                    </c:if> 
